...
public class BoardPR extends Board {
	...
	public void applyMove(MovePR move) {
		...
		if(move.isEnPassant()) {
			UtilsPR.getBoardSquareBefore(move.getTo(), this)
			.setOccupier(Colour.NONE);
		}
	}
	...
	public void unapplyMove(MovePR move) {
		...
		if(move.isEnPassant()) {
			getBoardSquare(UtilsPR.getBoardSquareBefore(move.getTo(), this))
			.setOccupier(movedPlayer.opposite());
